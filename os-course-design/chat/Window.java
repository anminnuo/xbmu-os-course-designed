...
public class Window implements MouseListener {
	...
	public MyDBOperation myOpr=new MyDBOperation(myDB);
	...
	public void show(){
		...
		JPanel bj = new JPanel() {//设置背景
			protected void paintComponent(Graphics g) {
				Image bg;
				try {
					bg = ImageIO.read(new File("image/开始背景.png"));
//					bg = ImageIO.read(new File("file:///E:/xbmu-courses/JAVA语言程序设计/javaworkspace/os-course-design/src/image/开始背景.png"));
